...
<h2 >Write whatever you want..</h2>
  <p >Edit your page ;)</p>
      <br>
<form method="post" action="editpage.php?date=<?php echo $_GET['date'];?>">
<?php include('errors.php'); ?>
<div class="form-group shadow-textarea">
<?php 
    global $page;
    bringOnePage($_GET["date"]);
?>
  <label for="exampleFormControlTextarea6">Enjoy writing!</label>
  <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="15" name="newpage_update" ><?php echo $page; ?></textarea>
    <div class="input-group">
    <button type="submit" class="btn" name="update_page" style=" padding: 10px;
    font-size: 20px;
    color: #ac6d5e;
    background: #f8c5ba44;
    border: none;
